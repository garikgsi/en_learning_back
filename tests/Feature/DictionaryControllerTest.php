...
class DictionaryControllerTest extends TestCase
{
    ...
    public function test_dictionary_counts_repeats_only_for_current_user(): void
    {
        ...
        $user = $this->userWithFirstGradeYear(now()->year - 3);
        $otherUser = $this->userWithFirstGradeYear(now()->year - 3);
    ...
    public function test_dictionary_sync_returns_all_available_words_and_latest_creation_date(): void
    {
        ...
        $this->withToken($this->accessToken($user))
            ...
            ->assertJsonPath('revision', 8)
            ->assertJsonPath('latestCreatedAt', '2026-09-21T00:00:00.000000Z')
    ...
    public function test_dictionary_sync_returns_only_words_created_after_cursor(): void
    {
        ...
        $this->withToken($this->accessToken($user))
            ->getJson('/api/v1/dictionary/sync?createdAfter=2026-08-13T10:00:00Z&availableGrade=2&revision=8')
            ->assertOk()
